export const drinks = [
  {
    ...
    type: "Alcoholic",
    alcoholic: true,
    imageUrl: require("../data/images/vodka.jpg"),
  ...
  },
  {
    ...
    name: "Orange Juice",
    type: "Non-alcoholic",
    imageUrl: require("../data/images/orange-juce.jpg"),
    alcoholic: false,
  ...
  },
  {
    ...
    name: "Gin",
    type: "Alcoholic",
    imageUrl: require("../data/images/gin.jpg"),
    alcoholic: true,
  ...
  },
  {
    ...
    name: "Tonic Water",
    type: "Non-alcoholic",
    imageUrl: require("../data/images/tonic-water.jpg"),
    alcoholic: false,
  ...
  },
  {
    ...
    name: "Rum",
    type: "Alcoholic",
    imageUrl: require("../data/images/rum.jpg"),
    alcoholic: true,
  ...
  },
  {
    ...
    name: "Cola",
    type: "Non-alcoholic",
    imageUrl: require("../data/images/cola.jpg"),
    alcoholic: false,
  ...
  },
  {
    ...
    name: "Viski",
    type: "Alcoholic",
    imageUrl: require("../data/images/visky.jpg"),
    alcoholic: true,
  ...
  },
  {
    ...
    name: "vinjak",
    type: "Alcoholic",
    imageUrl: require("../data/images/vinjak.jpg"),
    alcoholic: true,
  ...
  },
  {
    ...
    type: "Alcoholic",
    alcoholic: true,
    imageUrl: require("../data/images/tequila.jpg"),
  ...
  },
  {
    ...
    type: "Non-alcoholic",
    alcoholic: false,
    imageUrl: require("../data/images/soda-water.jpg"),
  ...
  },
  {
    ...
    type: "Non-alcoholic",
    alcoholic: false,
    imageUrl: require("../data/images/lemonade.jpg"),
  ...
  },
  {
    ...
    type: "Alcoholic",
    alcoholic: true,
    imageUrl: require("../data/images/bourbon.jpg"),
  ...
  },
  {
    ...
    type: "Alcoholic",
    alcoholic: true,
    imageUrl: require("../data/images/champagne.jpg"),
  ...
  },
  {
    ...
    type: "Alcoholic",
    alcoholic: true,
    imageUrl: require("../data/images/red-wine.jpg"),
  ...
  },
  {
    ...
    type: "Alcoholic",
    alcoholic: true,
    imageUrl: require("../data/images/white-wine.jpg"),
  ...
  },
  {
    ...
    type: "Alcoholic",
    alcoholic: true,
    imageUrl: require("../data/images/scotch.jpg"),
  ...
  },
  {
    ...
    type: "Non-alcoholic",
    alcoholic: false,
    imageUrl: require("../data/images/mojito-mix.jpg"),
...
export const cocktails = [
  {
    ...
    imageUrl: require("../data/images/screwdriver.jpg"),
  ...
  },
  {
    ...
    alcoholic: true,
    alcoholContent: "Single",
    imageUrl: require("../data/images/gin-tonic.jpg"),
    videoUrl: "https://www.youtube.com/watch?v=HJa4XPdL5-g",
    ingredients: [
      { drinkId: 3, quantity: 50, unit: "ml" },
  ...
  },
  {
    ...
    alcoholic: true,
    alcoholContent: "Single",
    imageUrl: require("../data/images/rum-cola.jpg"),
    videoUrl: "https://www.youtube.com/watch?v=HJa4XPdL5-g",
    ingredients: [
  ...
  },
  {
    ...
    alcoholic: true,
    alcoholContent: "Single",
    imageUrl: require("../data/images/visky-cola.jpg"),
    videoUrl: "https://www.youtube.com/watch?v=HJa4XPdL5-g",
    ingredients: [
  ...
  },
  {
    ...
    alcoholic: true,
    alcoholContent: "Single",
    imageUrl: require("../data/images/upalaMozga.jpg"),
    videoUrl: "https://www.youtube.com/watch?v=HJa4XPdL5-g",
    ingredients: [
      { drinkId: 7, quantity: 50, unit: "ml" },
      { drinkId: 6, quantity: 100, unit: "ml" },
  ...
  },
  {
    ...
    imageUrl: require("../data/images/demonski-kapacitet.jpg"),
    videoUrl: "https://www.youtube.com/watch?v=HJa4XPdL5-g",
    ingredients: [
      { drinkId: 1, quantity: 50, unit: "ml" },
  ...
  },
  {
    ...
    alcoholic: false,
    alcoholContent: null,
    imageUrl: require("../data/images/lemon-lime-bitters.jpg"),
    videoUrl: "https://www.youtube.com/watch?v=HJa4XPdL5-g",
    ingredients: [
